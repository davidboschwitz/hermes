...
{
    class MapWithOverlaysActivity : AppCompatActivity, IOnMapReadyCallback
    {
        ...
        void AddMonkeyMarkersToMap()
        {
            ...
            {
                var icon = BitmapDescriptorFactory.FromResource(Droid.Resource.Drawable.monkey);
                var markerOptions = new MarkerOptions()
        ...
        void PositionPolarBearGroundOverlay(LatLng position)
        {
            ...
            {
                var polarBear = BitmapDescriptorFactory.FromResource(Droid.Resource.Drawable.polarbear);
